...
import os
from src_path import RF100_VL_FSOD_PATH, MMGDINOL_PATH
...
class_name = 'everdaynew'
data_root = f'{RF100_VL_FSOD_PATH}/{class_name}'

class_name_list = [
    "Nestle every day dairy creamer 450g",
    "Nestle every day dairy whitener 19g",
    "Nestle every day dairy whitener 1kg",
    "Nestle every day dairy whitener 200g",
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'train/_annotations.coco.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'valid/_annotations.coco.json',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'test/_annotations.coco.json',
...
test_evaluator = dict(
    ann_file=f'{data_root}/test/_annotations.coco.json')
