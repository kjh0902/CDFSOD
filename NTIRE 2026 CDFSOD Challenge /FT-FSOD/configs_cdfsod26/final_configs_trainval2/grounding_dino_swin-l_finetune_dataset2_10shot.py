...
import os
from src_path import CDFSOD_PATH_26, MMGDINOL_PATH
...
class_name = 'dataset2'
data_root = f'{CDFSOD_PATH_26}/{class_name}'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'annotations/10_shot_sam3_conf08_trigger2_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'annotations/10_shot_sam3_conf08_trigger2_val.json',
...
val_evaluator = dict(
    ann_file=f'{data_root}/annotations/10_shot_sam3_conf08_trigger2_val.json')
