...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'annotations/10_shot_qwen_conf08_trigger2_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'annotations/10_shot_qwen_conf08_trigger2_val.json',
...
val_evaluator = dict(
    ann_file=f'{data_root}/annotations/10_shot_qwen_conf08_trigger2_val.json')
