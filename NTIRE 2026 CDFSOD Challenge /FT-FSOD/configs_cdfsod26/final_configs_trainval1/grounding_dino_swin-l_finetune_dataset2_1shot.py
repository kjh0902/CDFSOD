...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'annotations/1_shot_sam3_conf08_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'annotations/1_shot_sam3_conf08_val.json',
        data_prefix=dict(img='train/'),
...
val_evaluator = dict(
    ann_file=f'{data_root}/annotations/1_shot_sam3_conf08_val.json')
