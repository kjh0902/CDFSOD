...
backend_args = None
data_root = '/home/add_disk/qiuxingyu/NTIRE2025_CDFSOD/datasets/ArTaxOr'
...
test_evaluator = dict(
    ann_file='/home/add_disk/qiuxingyu/NTIRE2025_CDFSOD/datasets/ArTaxOr/annotations/test.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
