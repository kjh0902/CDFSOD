...
# DATASETS = [ "UODD", "FISH", "NEU-DET", "UODD", "ArTaxOr", "clipart1k" ]
# DATASETS = [ "UODD"], ,"FISH", 
SHOTS = ["5"]
# DATASETS = [ "NWPU_VHR-10"]
# SHOTS = ["3", "5", "10", "20"]
DATASETS = [ "Camouflage", "NWPU_VHR-10"]
# SHOTS = [ "2", "3", "5", "1"]
...
''')
        ...
        # 运行训练命令
        cmd = f"./tools/dist_test.sh {temp_config_path} /home/add_disk2/qiuxingyu/mmdetection/weights/groundingdino_swinb_cogcoor_mmdet-55949c9c.pth 4 --work-dir {work_dir}"
        print(f"执行命令: {cmd}")
