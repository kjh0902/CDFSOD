...
export CDFSOD_USE_CLASS_PROTOTYPES="${CDFSOD_USE_CLASS_PROTOTYPES:-1}"
...
TEXT_TAG="class_prototype"
if [ "$CDFSOD_USE_CLASS_PROTOTYPES" = "0" ]; then
  TEXT_TAG="class_name"
fi
...
echo "class prototypes: ${CDFSOD_USE_CLASS_PROTOTYPES}"
