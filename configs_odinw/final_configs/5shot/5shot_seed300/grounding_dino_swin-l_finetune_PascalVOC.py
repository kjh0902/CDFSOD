...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'train/fewshot_train_shot5_seed300.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'valid/fewshot_val_shot5_seed300.json',
...
val_evaluator = dict(
    ann_file=f'{data_root}/valid/fewshot_val_shot5_seed300.json')
