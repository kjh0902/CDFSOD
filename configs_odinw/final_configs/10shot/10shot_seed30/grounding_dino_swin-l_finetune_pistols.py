...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'export/fewshot_train_shot10_seed30.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'export/fewshot_val_shot10_seed30.json',
        data_prefix=dict(img='export/'),
...
val_evaluator = dict(
    ann_file=f'{data_root}/export/fewshot_val_shot10_seed30.json')
