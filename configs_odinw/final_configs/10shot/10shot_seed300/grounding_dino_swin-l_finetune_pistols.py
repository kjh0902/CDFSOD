...
class_name = 'pistols'
data_root = f'{ODINW_PATH}/{class_name}/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'export/fewshot_train_shot10_seed300.json',
        data_prefix=dict(img='export/'),
        return_classes=True,
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'export/fewshot_val_shot10_seed300.json',
        data_prefix=dict(img='export/'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'export/test_annotations_without_background.json',
        data_prefix=dict(img='export/'),
        pipeline=test_pipeline, 
        return_classes=True))

val_evaluator = dict(
    ann_file=f'{data_root}/export/fewshot_val_shot10_seed300.json')

test_evaluator = dict(
    ann_file=f'{data_root}/export/test_annotations_without_background.json')
