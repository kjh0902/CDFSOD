...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'train/fewshot_train_shot10_seed300.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'valid/fewshot_val_shot10_seed300.json',
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=f'valid/annotations_without_background.json',
        data_prefix=dict(img='valid/'),
        pipeline=test_pipeline, 
        return_classes=True))

val_evaluator = dict(
    ann_file=f'{data_root}/valid/fewshot_val_shot10_seed300.json')

test_evaluator = dict(
    ann_file=f'{data_root}/valid/annotations_without_background.json')
